...
export default function TaskDetailDrawer({ task, onClose }: { task: Task; onClose: () => void }) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Content */}
        <form onSubmit={onSave} style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <div>
                ...
                >
                  {allTasks?.filter(t => t.id !== task.id).map(t => (
                    <option key={t.id} value={t.id} style={{ padding: '4px' }}>
                      {t.name} ({t.mandays}d)
                    </option>
                  ))}
                </select>
                <p style={{ 
                  ...
                  Hold Ctrl/Cmd to select multiple tasks that must be completed before this task
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button 
                ...
                style={{
                  background: isPending ? 'var(--disabled-bg)' : 'var(--accent)',
                  color: 'white',
                  border: 'none',
                  borderRadius: '6px',
                  padding: '10px 24px',
